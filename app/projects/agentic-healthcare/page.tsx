...
export default function ProjectPage() {
  return (
    <main className="min-h-screen bg-[#0F172A] text-slate-200 font-sans selection:bg-[#D97706] selection:text-white">
      ...
      {/* --- HERO SECTION --- */}
      <header className="pt-32 pb-20 px-4 md:px-6 border-b border-slate-800 bg-gradient-to-b from-[#0F172A] to-[#1E293B]">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <article className="col-span-1 md:col-span-9 space-y-20 md:space-y-24">
          ...
          <section id="architecture" className="space-y-6">
            ...
            <div className="relative mt-12 p-6 md:p-8 bg-slate-900 rounded-2xl border border-slate-700 overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                ...
                <div className="text-slate-500 hidden md:block"><ArrowRight size={24} /></div>
                <div className="text-slate-500 block md:hidden rotate-90"><ArrowRight size={24} /></div>
          ...
          {/* 03. ROADMAP & 04. OUTCOME (Kept largely same but responsive) */}
          <section id="execution" className="space-y-8">
            ...
            <div className="border-l-2 border-slate-800 ml-4 space-y-12">
              <div className="relative pl-8">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white">Phase 1: Validation (Rule-Based)</h3>
                <p className="text-slate-400 mt-2 text-sm md:text-base">Established the Knowledge Base utility...</p>
              </div>
              <div className="relative pl-8">
                <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full bg-slate-800 border-2 border-slate-600"></div>
                <h3 className="text-lg md:text-xl font-bold text-white">Phase 2: The Baseline (Mesa Simulation)</h3>
                <p className="text-slate-400 mt-2 text-sm md:text-base">Developed a separate agent-based model using Mesa...</p>
              </div>
              <div className="relative pl-8">
                <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full bg-[#D97706] border-2 border-[#D97706] shadow-[0_0_10px_#D97706]"></div>
                <h3 className="text-lg md:text-xl font-bold text-white">Phase 3: Intelligent Orchestration</h3>
                <p className="text-slate-400 mt-2 text-sm md:text-base">The final evolution. Replaced statistical rules with LLM-driven Agents...</p>
              </div>
            </div>
          </section>
          ...
          <section id="impact" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800">
                ...
                <p className="text-slate-400 text-sm">Successfully validated that Agentic Workflows...</p>
              </div>
              <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800">
                <h4 className="text-white font-bold mb-2">Ecosystem Fit</h4>
                <p className="text-slate-400 text-sm">Demonstrated how agent-based modeling fits...</p>
              </div>
            </div>
            
            <div className="mt-12 p-6 md:p-8 bg-gradient-to-r from-[#D97706]/10 to-transparent border border-[#D97706]/20 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-xl font-bold text-white">Ready to see the code?</h3>
                <p className="text-slate-400 text-sm mt-1">The architecture is modular and ready for inspection.</p>
              </div>
